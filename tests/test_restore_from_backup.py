...
@pytest.mark.parametrize("driver", ["../outside", "nested/driver", ".hidden"])
def test_legacy_relative_driver_must_be_a_bare_name(monkeypatch, tmp_path: Path, driver: str) -> None:
